...
#     for tk in  frappe.get_all('Task',['name','issue','completed_by']):
...
#         if len(frappe.get_all('DocShare',{'user':tk.get('completed_by'),"share_doctype": 'Issue',"share_name": tk.get('issue')})) == 0: 
#             docshare = frappe.new_doc("DocShare")
#             docshare.update({
#                   "user": tk.get('completed_by'),
#                   "share_doctype": 'Issue',
#                   "share_name": tk.get('issue'),
#                   "read": 1,
#                   "write": 1
#             })
